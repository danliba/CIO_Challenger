...
% time
years=tempall(697:end,1);
months=tempall(697:end,2);
days=tempall(697:end,3);
timed=datenum(years,months,days);

% timeanom
yearsa=anomaall(697:end,1);
monthsa=anomaall(697:end,2);
daysa=anomaall(697:end,3);
...
% variables
temps=tempall(697:end,4:end);
anomas=anomaall(697:end,4:end);
...
print('Temperatura Superficial del Mar Diaria.png','-dpng','-r500');
%% 
...
print('Anomalia diaria de Temperatura Superficial del Mar.png','-dpng','-r500');